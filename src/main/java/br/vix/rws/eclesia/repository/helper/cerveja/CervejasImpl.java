...
import br.vix.rws.eclesia.repository.paginacao.PaginacaoUtil;
...
public class CervejasImpl implements CervejasQueries {
	...
	public List<CervejaDTO> porSkuOuNome(String skuOuNome) {
		String jpql = "select new br.vix.rws.eclesia.dto.CervejaDTO(codigo, sku, nome, origem, valor, foto) "
	...
	public ValorItensEstoque valorItensEstoque() {
		String query = "select new br.vix.rws.eclesia.dto.ValorItensEstoque(sum(valor * quantidadeEstoque), sum(quantidadeEstoque)) from Cerveja";
